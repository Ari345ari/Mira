...
function Toggle({ on, onToggle }: { on: boolean; onToggle: () => void }) {
  return (
    <button
      type="button" onClick={onToggle} role="switch" aria-checked={on}
...
export default function SettingsPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    if (user && accessToken) {
      setAuth({ ...user, full_name: name, preferred_language: lang }, accessToken)
    }
    setSaving(false)
      ...
      <div className="flex gap-8">
            ...
            >
              <Icon
                style={{
                  ...
                  color: active === id ? 'var(--accent-hi)' : 'var(--text-3)',
                }}
              />
              {label}
            </button>
        ...
        <div className="flex-1 max-w-xl">
              ...
              <form onSubmit={handleSave} className="p-6 space-y-5">
                ...
                <div className="flex justify-end pt-2">
                  <button
                    ...
                    className="btn-accent rounded-xl px-6 py-2.5 text-[13px] font-bold disabled:opacity-50"
                  >
            ...
            >
              ...
              <form onSubmit={handlePasswordChange} className="p-6 space-y-4">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="btn-accent rounded-xl px-6 py-2.5 text-[13px] font-bold"
                  >
                    Update password
                  </button>
                </div>
          ...
          {active === 'danger' && (
            <div
              className="overflow-hidden rounded-2xl"
              style={{ background: 'var(--card)', border: '1px solid var(--red-border)' }}
            >
              <div
                className="px-6 py-5 flex items-center gap-3"
                style={{ borderBottom: '1px solid var(--red-border)', background: 'var(--red-bg)' }}
              >
                ...
                <div>
                  ...
                  <p className="text-[12px] mt-0.5" style={{ color: 'rgba(239,68,68,0.65)' }}>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="text-[12px] mt-0.5" style={{ color: 'var(--text-3)' }}>
                      Permanently remove all meetings, transcripts, and protocols
                    </p>
                  </div>
                  <button
                    onClick={() => toast.error('Disabled in demo mode')}
                  ...
                  <div className="flex items-start justify-between gap-4 mb-4">
                    ...
                    {deleteStep === 'idle' && (
                      <button
                        ...
                        className="shrink-0 rounded-xl px-4 py-2 text-[13px] font-semibold text-white transition-all"
                  ...
                  {deleteStep === 'confirm' && (
                    ...
                    >
                      ...
                      <input
                        ...
                        className="input-dark block w-full px-3.5 py-2.5 text-[13px]"
                        style={{
                          borderColor: deleteConfirm === 'DELETE' ? 'var(--red)' : 'var(--red-border)',
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="rounded-xl px-5 py-2 text-[13px] font-bold text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
